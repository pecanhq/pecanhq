...
namespace PecanHQ.Grant.Types
{
    ...
    public class RegisterAccount
    {
        ...
        /// <summary>
        /// A flag indicating the account should be created as a new
        /// organization with a shadow profile belonging to the
        /// administrator that triggered this action.
        /// </summary>
        ...
        public override bool Equals(object? obj)
        {
            if (obj is RegisterAccount that)
            {
                return Equals(this.AdministratorId, that.AdministratorId)
                    && Equals(this.Display, that.Display)
                    && Equals(this.Multitenant, that.Multitenant)
                    && Equals(this.Claims, that.Claims)
                    && Equals(this.Description, that.Description);
            }
            return false;
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(AdministratorId, Display, Multitenant, Claims, Description);
        }
    ...
    public class SetTemplate
    {
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(Name, Mimetype, Description, Literal, Entities);
        }
