...
namespace PecanHQ.Grant.Types
{
    ...
    public class AccountAssertion : PecanHQ.INavigationAware
    {
        ...
        /// <summary>
        /// The UNIX timestamp (seconds) processing started for this
        /// request.
        /// </summary>
        ...
        {
            return HashCode.Combine(AccountId, Modified, Timestamp, Secret);
        }
    ...
    /// Information about an account.
    /// </summary>
    public class Accountability : PecanHQ.INavigationAware
    {
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(AccountId, Display, Organization);
        }
    ...
    public class AppManifest : PecanHQ.INavigationAware
    {
        ...
        /// <summary>
        /// The UNIX timestamp (seconds) processing for this request
        /// began.
        /// </summary>
        [JsonPropertyName("timestamp")]
        public long Timestamp { get; set; }
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(Authority, AccountId, Timestamp, Permissions, Services);
        }
    ...
    /// </summary>
    public class AuditEvent : PecanHQ.INavigationAware
    {
        ...
        /// <summary>
        /// The accountability that undertook the action.
        /// </summary>
        [JsonPropertyName("actor")]
        public Accountability Actor { get; set; }

        /// <summary>
        /// The name of this audit event.
        /// </summary>
        [JsonPropertyName("action")]
        public string Action { get; set; }

        /// <summary>
        /// A detailed audit message.
        /// </summary>
        [JsonPropertyName("description")]
        public string Description { get; set; }

        /// <summary>
        /// A flag indicating the audit event triggered a cache
        /// invalidation.
        /// </summary>
        ...
        public override bool Equals(object? obj)
        {
            if (obj is AuditEvent that)
            {
                return Equals(this.AuditId, that.AuditId)
                    && Equals(this.Timestamp, that.Timestamp)
                    && Equals(this.Actor, that.Actor)
                    && Equals(this.Action, that.Action)
                    && Equals(this.Description, that.Description)
                    && Equals(this.Purge, that.Purge)
                    && Equals(this.Accountability, that.Accountability);
            }
            return false;
        }
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(AuditId, Timestamp, Actor, Action, Description, Purge, Accountability);
        }

    }

    /// <summary>
    /// A link between a name and a resource identifier.
    /// </summary>
    public class AvailableResource : PecanHQ.INavigationAware
    {
        ...
        public override bool Equals(object? obj)
        {
            if (obj is AvailableResource that)
            {
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(ResourceId, Name);
        }

    }

    /// <summary>
    /// Eviction information for downstream caches.
    /// </summary>
    public class CacheSummary : PecanHQ.INavigationAware
    {
        ...
        /// <summary>
        /// The UNIX timestamp (seconds) that marks the end of the
        /// eviction period covered by this summary.
        /// </summary>
        [JsonPropertyName("hwm")]
        public long Hwm { get; set; }

        /// <summary>
        /// All accountabilities that were evicted over the period
        /// covered by this summary.
        /// </summary>
        [JsonPropertyName("evicted")]
        public List<Guid> Evicted { get; set; }

        /// <summary>
        /// The UNIX timestamp (seconds) the entire cache should be
        /// purged, if a purge occurred over the period covered by this
        /// summary.
        /// </summary>
        [JsonPropertyName("purge")]
        public long? Purge { get; set; }

        /// <summary>
        /// The audit event key to pair with the high water mark to
        /// resume from the end of this eviction period.
        /// </summary>
        [JsonPropertyName("key")]
        ...
        public override bool Equals(object? obj)
        {
            if (obj is CacheSummary that)
            {
                return Equals(this.Hwm, that.Hwm)
                    && Equals(this.Evicted, that.Evicted)
                    && Equals(this.Purge, that.Purge)
                    && Equals(this.Key, that.Key);
            }
            return false;
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(Hwm, Evicted, Purge, Key);
        }
    ...
    /// An entity reference.
    /// </summary>
    public class EntityToken : PecanHQ.INavigationAware
    {
        ...
        /// <summary>
        /// The dot-separated field path to the entity key.
        /// </summary>
        [JsonPropertyName("path")]
        public string Path { get; set; }

        /// <summary>
        /// The referenced resource identifier.
        /// </summary>
        [JsonPropertyName("resource_id")]
        public Guid ResourceId { get; set; }
        ...
        public override bool Equals(object? obj)
        {
            if (obj is EntityToken that)
            {
                return Equals(this.Path, that.Path)
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(Path, ResourceId);
        }
    ...
    /// <summary>
    /// An audit message parse result.
    /// </summary>
    public class ParseResult : PecanHQ.INavigationAware
    {
        ...
        public ParseResult(
            ...
            string mimetype,
            bool editable,
            List<EntityToken> entities,
            List<ValueToken> tokens,
        ...
        /// <summary>
        /// The name of the resource that emitted this event.
        /// </summary>
        ...
        /// <summary>
        /// The mime type targeted by this template.
        /// </summary>
        [JsonPropertyName("mimetype")]
        public string Mimetype { get; set; }

        /// <summary>
        /// A flag indicating the template is editable.
        /// </summary>
        [JsonPropertyName("editable")]
        public bool Editable { get; set; }

        /// <summary>
        /// All entity tokens associated with this audit event.
        /// </summary>
        [JsonPropertyName("entities")]
        public List<EntityToken> Entities { get; set; }

        /// <summary>
        /// All value tokens associated with this audit event.
        /// </summary>
        [JsonPropertyName("tokens")]
        public List<ValueToken> Tokens { get; set; }

        /// <summary>
        /// All resources that can be tagged.
        /// </summary>
        [JsonPropertyName("resources")]
        public List<AvailableResource> Resources { get; set; }

        /// <summary>
        /// The template literal for creating audit event descriptions.
        /// </summary>
        ...
        public override bool Equals(object? obj)
        {
            if (obj is ParseResult that)
            {
                return Equals(this.ClaimGroup, that.ClaimGroup)
                    ...
                    && Equals(this.Name, that.Name)
                    && Equals(this.Mimetype, that.Mimetype)
                    && Equals(this.Editable, that.Editable)
                    && Equals(this.Entities, that.Entities)
                    && Equals(this.Tokens, that.Tokens)
                    && Equals(this.Resources, that.Resources)
                    && Equals(this.Literal, that.Literal)
                    && Equals(this.Description, that.Description);
            }
            return false;
        }
    ...
    public class UserProfile : PecanHQ.INavigationAware
    {
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(Authority, AccountId, Timestamp, Display, Assertions, Tenant);
        }
    ...
    /// <summary>
    /// A lexer token from an audit message.
    /// </summary>
    public class ValueToken : PecanHQ.INavigationAware
    {
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(Key, Path, Value);
        }
