...
namespace PecanHQ.Grant.Resources
{
    ...
    /// <summary>
    /// A bundle of links for all top-level resources in the grant portal
    /// </summary>
    public class GrantLinks : INavigationAware
    {
    ...
    /// </summary>
    public interface IGrantResource : IResource
    {
        ...
        /// <item>
        /// <term>Navigations</term>
        /// <description>The create account resource has 8 navigations</description>
        /// <list type="bullet">
        /// <item>From <c>/</c> to the account context</item>
        ...
        /// </remarks>
        /// <exception cref="System.Security.SecurityException">Thrown when the url is unavailable.</exception>
        Resources.CreateAccountUri AsCreateAccountUri(CancellationToken token = default);
    ...
    public interface IArtifactResource : ILinkable<Types.ArtifactDetails>, IResource
    {
        ...
        /// <item>
        /// <term>Navigations</term>
        /// <description>The create service resource has 7 navigations</description>
        /// <list type="bullet">
    ...
    public sealed class RefreshUri : UriBuilder
    {
            ...
            string? session = null)
        {
            ...
            return await handler.SendAsync(r, this.token)
                .GetFromJsonAsync<Types.UserSession>(this.token) ?? throw new ServiceException(HttpStatusCode.OK, new ServiceError(
                    "evaluation.3000",
                    "An unexpected empty response was received from the server",
    ...
    public sealed class CreateServiceUri : UriBuilder
    {
            ...
            meta::IAttachment? openapi = null)
        {
            ...
            r.Content = c;
            return await handler.SendAsync(r, this.token)
                .GetFromJsonAsync<Types.Service>(this.token) ?? throw new ServiceException(HttpStatusCode.OK, new ServiceError(
                    "evaluation.3000",
                    "An unexpected empty response was received from the server",
    ...
    public sealed class CreateResourceUri : UriBuilder
    {
            ...
            string description)
        {
            ...
            r.Content = c;
            return await handler.SendAsync(r, this.token)
                .GetFromJsonAsync<Types.ResourceMetadata>(this.token) ?? throw new ServiceException(HttpStatusCode.OK, new ServiceError(
                    "evaluation.3000",
                    "An unexpected empty response was received from the server",
    ...
    public sealed class CreateRoleUri : UriBuilder
    {
            ...
            string? scope = null)
        {
            ...
            r.Content = c;
            return await handler.SendAsync(r, this.token)
                .GetFromJsonAsync<Types.Role>(this.token) ?? throw new ServiceException(HttpStatusCode.OK, new ServiceError(
                    "evaluation.3000",
                    "An unexpected empty response was received from the server",
    ...
    public sealed class CreateClaimUri : UriBuilder
    {
            ...
            bool unique)
        {
            ...
            r.Content = c;
            return await handler.SendAsync(r, this.token)
                .GetFromJsonAsync<Types.Claim>(this.token) ?? throw new ServiceException(HttpStatusCode.OK, new ServiceError(
                    "evaluation.3000",
                    "An unexpected empty response was received from the server",
    ...
    /// </summary>
    public sealed class CreateAccountUri : UriBuilder
    {
        ...
        /// <summary>
        /// Create a new UriBuilder for the create account action
        /// </summary>
        public CreateAccountUri(
            Uri uri,
            IHttpHandler handler,
            CancellationToken token) : base(uri)
        {
        ...
        public async Task<Types.Account> PostAsync(
            ...
            Guid? organizationId = null)
        {
            string d = JsonSerializer.Serialize(new Types.CreateAccount(
                display,
                claims)
                {
            ...
            r.Content = c;
            return await handler.SendAsync(r, this.token)
                .GetFromJsonAsync<Types.Account>(this.token) ?? throw new ServiceException(HttpStatusCode.OK, new ServiceError(
                    "evaluation.3000",
                    "An unexpected empty response was received from the server",
                    "The create account service returned an empty response, a 404 [NotFound] or a valid payload are expected."));
        }
    ...
    public sealed class CreateArtifactUri : UriBuilder
    {
            ...
            string description)
        {
            ...
            r.Content = c;
            return await handler.SendAsync(r, this.token)
                .GetFromJsonAsync<Types.Artifact>(this.token) ?? throw new ServiceException(HttpStatusCode.OK, new ServiceError(
                    "evaluation.3000",
                    "An unexpected empty response was received from the server",
    ...
    public sealed class CreateProviderUri : UriBuilder
    {
            ...
            string? tenant = null)
        {
            ...
            r.Content = c;
            return await handler.SendAsync(r, this.token)
                .GetFromJsonAsync<Types.Provider>(this.token) ?? throw new ServiceException(HttpStatusCode.OK, new ServiceError(
                    "evaluation.3000",
                    "An unexpected empty response was received from the server",
    ...
    public sealed class RefreshProfileUri : UriBuilder
    {
            ...
            Guid accountId)
        {
            ...
            r.Content = c;
            return await handler.SendAsync(r, this.token)
                .GetFromJsonAsync<Types.UserProfile>(this.token) ?? throw new ServiceException(HttpStatusCode.OK, new ServiceError(
                    "evaluation.3000",
                    "An unexpected empty response was received from the server",
    ...
    public sealed class RegisterAppUri : UriBuilder
    {
            ...
            string? description = null)
        {
            ...
            r.Content = c;
            return await handler.SendAsync(r, this.token)
                .GetFromJsonAsync<Types.AppRegistration>(this.token) ?? throw new ServiceException(HttpStatusCode.OK, new ServiceError(
                    "evaluation.3000",
                    "An unexpected empty response was received from the server",
